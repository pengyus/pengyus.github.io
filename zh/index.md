...
title: 徐鹏宇
position: 计算机科学博士研究生
affiliation: 北京交通大学<br>北京市海淀区上园村3号
description: 北京交通大学计算机科学博士研究生
---

## 简介
我目前是北京交通大学计算机科学专业的博士研究生，导师为景丽萍教授与于剑教授。研究兴趣主要围绕机器学习与自然语言处理，重点关注**弱监督/非完美数据学习**下的**多标签学习**，以及**多轮对话式大模型**的建模与评测。

在工业侧，我参与/研发过面向真实电话营销场景的语音智能体与评测基准（ASR+LLM+TTS），也做过集装箱识别、OCR识别与铁路时间序列预测等应用。

## 研究方向
- 多标签学习（噪声/缺失监督、长尾/极端分类）
- 多轮对话式大模型与评测（含 RAG / 用户模拟）
- 语音智能体与真实场景基准（ASR+LLM+TTS）

## 教育经历
- **2021.09 – 至今**，北京交通大学，计算机科学，博士研究生。导师：景丽萍教授、于剑教授。
- **2024.01 – 2025.01**，南洋理工大学（NTU），College of Computing and Data Science（CCDS），访问博士。合作导师：Lei Feng 教授、Chee Keong Kwoh 教授、Fang Li 博士。
- **2019.09 – 2021.06**，北京交通大学，统计学，硕士研究生。
- **2015.09 – 2019.06**，北京交通大学，数学与应用数学（知行班），学士。
...
- **Learning Neural Operators from Partial Observations via Latent Autoregressive Modeling**  
  Jingren Hou, Hong Wang, **Pengyu Xu†**（指导）, Chang Gao, Huafeng Liu, Liping Jing.  
  *AAAI*, 2026（**CCF-A**）  
...
- **VoiceAgentEval: A Dual-Dimensional Benchmark for Expert-Level Intelligent Voice-Agent Evaluation**  
  **Pengyu Xu\***, Shijia Li\*, Ao Sun\*, et al.（与美团、Xbench、Agora 合作）  
  *arXiv*, 2025  
...
- **Multi-Label Classification based on Dual-Stream Autoencoders（基于双流自编码器的多标签分类）**  
  Hongjian Sun\*, **Pengyu Xu\***（指导）, Sijin Lu, Bing Liu, Liping Jing, Jian Yu.  
  *计算机科学与探索*, 2025（**中文 CCF-B**）

- **Sequential Tag Recommendation（序列标签推荐）**  
  Bing Liu\*, **Pengyu Xu\***（指导）, Shijing Wang, Sijin Lu, Hongjian Sun, Liping Jing.  
  *计算机科学*, 2025（**中文 CCF-B**）
...
- **Cross-Modal Content Interaction with Retrieval Augmentation for Tag Recommendation in Software Q&A Websites**  
  Sijin Lu\*, **Pengyu Xu\***（指导）, Bo Wang, Bing Liu, Hongjian Sun, Liping Jing, Jian Yu.  
  *arXiv*, 2024  
...
- **Bootstrap Decomposition Enhanced Orthogonal-Basis Projection Model for Long-Term Time Series Forecasting**  
  Xiaoyu Wang, **Pengyu Xu**（指导）, Mingyang Song, Liping Jing.  
  *IJCNN*, 2023  
...
- **Semantic Guide for Semi-Supervised Few-Shot Multi-Label Node Classification**  
  ...
  *Information Sciences*, 2022（**SCI-An1**）  
...
## 项目与工业经历
- **面向美团商家的智能外呼大模型系统**  
  美团，履约平台技术部，LLM 算法工程师实习，2025.05–2025.08。

- **真实噪声多标签学习（纵向课题）**  
  中央高校基本科研业务费，负责人，2023.06–2025.01。

- **中欧班列集装箱识别与数据分析**  
  中铁集装箱运输有限责任公司，负责人，2022.01–2023.01。

## 荣誉奖励
- 国家留学基金委（CSC）国家公派留学奖学金，2023。
- 毫末智行 HAOMO.AI 奖学金，北京交通大学计算机与信息技术学院，2022。
- 北京交通大学一等奖学金，2021/2022/2023/2024。
- 全国研究生数学建模竞赛二等奖，2021（[获奖比例 13.4%](https://cpipc.acge.org.cn//cw/detail/4/2c90800c7da2aae7017da35af2db0028)）[[Code]](https://github.com/stxupengyu/Air-Quality-Prediction)
- 全国研究生数学建模竞赛二等奖，2020（[获奖比例 14.6%](https://cpipc.acge.org.cn//cw/detail/4/2c9088a57597479f0175f7ca3ba413de)）[[Code]](https://github.com/stxupengyu/P300-BCI-Data-Analysis)
...
### 硕士生指导
- Xiaoyu Wang（2021–2024）：非线性长时序预测；后续去向：University of Leeds 博士。
- Sijin Lu（2022–2024）：不完备多模态多标签学习；后续去向：BJTU 博士。
- Bing Liu（2022–2025）：序列标签推荐；后续去向：邮储银行。
- Hongjian Sun (2023-2026): 多标签持续学习；后续去向：百度。

## 爱好
- **阅读**：偏好人物传记、历史与财经相关书籍。
- **运动**：保持规律锻炼（健身、游泳、羽毛球等）。
- **其他**：电影、戏剧、脱口秀、说唱等。
