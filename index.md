...
layout: homepage
lang: en
description: Ph.D. candidate at Beijing Jiaotong University (BJTU)
---
...
## Research Interests
- Multi-label learning with non-perfect supervision (noisy/missing labels, long-tailed data)
- Multi-turn conversational LLMs and dialogue evaluation
- Practical ML/NLP applications and benchmarks
...
- **Sequential Tag Recommendation (序列标签推荐)**  
  Bing Liu\*, **Pengyu Xu\*** (Mentor), Shijing Wang, Sijin Lu, Hongjian Sun, Liping Jing, Jian Yu.  
...
- **Mitigating Over-generation for Unsupervised Keyphrase Extraction with Heterogeneous Centrality Detection**  
  Mingyang Song, **Pengyu Xu**, Yi Feng, Huafeng Liu, Bing Liu, Liping Jing.  
  *EMNLP 2023* (**CCF-B**)  
...
- **Triple Alliance Prototype Orthotist Network for Long-Tailed Multi-Label Text Classification**  
  Lin Xiao, **Pengyu Xu**, Mingyang Song, Huafeng Liu, Bing Liu, Liping Jing, Xiangliang Zhang.  
...
- Hongjian Sun (2023-2026), Thesis: Multi-label Continual learning. Next position: Baidu.
